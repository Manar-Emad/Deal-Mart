              ...
              Expanded(child: defContainer(context, Column(
                children: [
                  Row(
                    ...
                    arrowIcon((){navigateTo(context, const WalletBalanceScreen());}),
                  ],),
                  Padding(
                    padding: const EdgeInsets.all(10.0),
            ...
            SizedBox(
              ...
              child: defContainer(context,
                  Column(children: [
                    ...
                    arrowIcon((){navigateTo(context,  ContactUsScreen());}),
                    ),
                  ],)),
            ),
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  TextButton(child: Text('Sign out',style: red14bold(),),onPressed: (){
